...
describe('Tests for Sum of given numbers', () => {
  ...
  test('Check for multiple numbers', () => {
    ...
    expect(sumOfGivenNumbers("5;10")).toBe(15) // return sum of given numbers
  })
  test('Check for -ve numbers', () => {
    expect(sumOfGivenNumbers("-4;-8")).toThrow('negatives not allowed - -4,-8')
  })
  test('Check for invalid delimiter pattern', () => {
    expect(sumOfGivenNumbers("-4:-8")).toThrow('Values given with Invalid delimiter pattern. Please check the description for correct pattern')
  })
})